    ...
    <div className="relative z-10 px-6 py-4 bg-white border-b-4 border-gray-800 shadow-[0_4px_0_#374151]">
      <div className="flex items-center justify-center space-x-6">
        {tabs.map((tab) => {
          ...
          const isStudioLocked = tab.id === 'studio' && !user?.studio_unlocked;
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : isStudioLocked
                  ? "bg-yellow-50 border-yellow-400 text-yellow-700 hover:bg-yellow-100 active:translate-x-[1px] active:translate-y-[1px] active:shadow-[1px_1px_0_#374151]"
